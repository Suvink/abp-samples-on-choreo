...
public class OpenIddictDataSeedContributor : OpenIddictDataSeedContributorBase, IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateScopesAsync()
    {
        ...
        {
            Name = "ChoreoSample", 
            DisplayName = "ChoreoSample API", 
            Resources = { "ChoreoSample" }
        });
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        // Blazor Client
        var consoleAndBlazorClientId = configurationSection["ChoreoSample_Blazor:ClientId"];
        if (!consoleAndBlazorClientId.IsNullOrWhiteSpace())
        {
            var blazorRootUrl = configurationSection["ChoreoSample_Blazor:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["ChoreoSample_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["ChoreoSample_Swagger:RootUrl"]?.TrimEnd('/');
