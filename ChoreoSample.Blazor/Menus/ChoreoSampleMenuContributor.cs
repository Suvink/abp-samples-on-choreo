using ChoreoSample.Blazor.Server.Menus;
using ChoreoSample.Localization;
using ChoreoSample.Permissions;
...
namespace ChoreoSample.Menus;

public class ChoreoSampleMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public ChoreoSampleMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<ChoreoSampleResource>();

        context.Menu.AddItem(new ApplicationMenuItem(
            ChoreoSampleMenus.Home,
            l["Menu:Home"],
            "/",
            icon: "fas fa-home",
            order: 1
        ...
        */
        ...
        if (await context.IsGrantedAsync(ChoreoSamplePermissions.Books.Default))
        {
